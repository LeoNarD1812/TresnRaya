package pe.edu.upeu.ter.conexion;
    ...
    public Connection getConnection() {
        ...
        if (connection == null) {
            synchronized (ConnS.class) {
                if (connection == null) {
                    try {
                        String dbUrl="jdbc:sqlite:data/bd_tresenraya.db?foreign_keys=on;";

                        //String dbUrl= "jdbc:sqlite:" + util.getFileExterno("data","admision_db.db").getAbsolutePath() + "?foreign_keys=on;";
